      ...
      <div class="row">
        <div class="col-md-4 sticky-sidebar" style="padding-left: 7.5rem;">
          <div class="custom-column" style="background-color: #fee4d9; border-radius: 10px; border: 1px solid #ccc;">
            ...
            <div class="row">
              <div class="col-12">
                <h6 id="titulo1-toc">Titulo 1</h6>
                <h6 id="titulo2-toc">Titulo 2</h6>
                <h6 id="titulo3-toc">Titulo 3</h6>
                <h6 id="titulo4-toc">Titulo 4</h6>
              </div>
            </div>
          </div>
        </div>
