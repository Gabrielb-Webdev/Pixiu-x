                ...
                <ul class="navbar-nav ml-auto">
                    ...
                    <?php if (isset($_SESSION['username'])) : ?>
                        <li class="nav-item dropdown custom-dropdown">
                            <a class="nav-link btn-dashboard" href="../admin/dashboard.php" id="userDropdown" role="button">Dashboard</a>
                            <a class="custom-dropdown-menu dropdown-item btn-logout" href="../database/logout.php">Logout</a>
                        </li>
                    <?php endif; ?>
                </ul>
            </div>
