...
<head>
  ...
  <meta name="description" content="Pixiu X se especializa en implementación, optimización y consultoría de HubSpot para maximizar la eficiencia y el crecimiento de tu negocio. ¡Reserva una llamada hoy mismo!">
  <meta name="keywords" content="Pixiu X, implementación de HubSpot, optimización de HubSpot, consultoría de HubSpot, integración de CRM, gestión de datos, automatización de flujos de trabajo, onboarding de HubSpot, formación en HubSpot, configuración de HubSpot, soporte de HubSpot, experto en HubSpot, servicios de HubSpot, automatización empresarial, marketing digital, marketing inbound, gestión de relaciones con clientes, estrategias de crecimiento empresarial">
  ...
  <title>Pixiu X | Implementación y Consultoría de HubSpot (ES)</title>
</head>
      ...
      <div class="row h-100 align-items-center">
        ...
        <div class="col-md-6">
          <div class="welcome-image floating-image">
            <img src="sources/images/Imagenes Pixiu/Operating system-pana.png" alt="Imagen de bienvenida" style="max-width: 100%; height: auto" />
          </div>
        </div>
      </div>
    </div>
  ...
  <section id="detalle-servicios-hubspot" style="padding: 50px">
    <div class="container-fluid">
      <div class="row mb-5" style="margin-bottom: -7.5rem !important">
        ...
        <div class="col-md-6">
          <img src="sources/images/Imagenes Pixiu/Operating system-amico.png" alt="Implementación y Formación de HubSpot" class="service-detail-img" />
        </div>
      </div>
      <div class="row mb-5" style="margin-bottom: -7.5rem !important">
        ...
        <div class="col-md-6 order-md-1">
          <img src="sources/images/Imagenes Pixiu/Operating system-pana.png" alt="Optimización de HubSpot" class="service-detail-img" />
        </div>
      </div>
      <div class="row mb-5" style="margin-bottom: -2.5rem !important">
        ...
        <div class="col-md-6">
          <img src="sources/images/Imagenes Pixiu/Operating system-rafiki.png" alt="Consultoría Personalizada de HubSpot" class="service-detail-img" />
        </div>
      </div>
    </div>
  </section>

  <!-- Sección de Paquetes de Implementación y Soporte de HubSpot -->
  <section id="paquetes-hubspot" style="padding: 50px; background-color: #f8f9fa">
    <div class="container-fluid">
      <div class="row">
        <div class="col-md-12">
        ...
        <div class="col-md-3">
          <div class="plan">
            <div class="inner">
              ...
              <div class="action">
                <a class="button" href="https://meetings.hubspot.com/pixiu" style="color: #fff" target="_blank">Reservar una Llamada</a>
              </div>
            </div>
          </div>
        </div>
            ...
            <div class="inner">
              ...
              <ul class="features">
                ...
                <li>
                  ...
                  <span>Optimización a largo plazo de
