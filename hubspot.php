...
<head>
  ...
  <meta name="description" content="Pixiu X specializes in seamless HubSpot onboarding, training, and consulting services to maximize your business's efficiency and growth. Book a call today!">
  <meta name="keywords" content="Pixiu X, HubSpot implementation, HubSpot optimization, HubSpot consulting, CRM integration, data management, workflow automation, HubSpot onboarding, HubSpot training, HubSpot setup, HubSpot support, HubSpot expert, HubSpot services, business automation, marketing automation, sales automation, digital marketing, inbound marketing, customer relationship management, business growth strategies">
      ...
      <div class="row h-100 align-items-center">
        <div class="col-md-6">
          <div class="welcome-content text-left">
            ...
            <a href="https://meetings.hubspot.com/pixiu" class="btn mt-5 custom-btn" target="_blank">Book A Call</a>
          </div>
        </div>
        <div class="col-md-6">
  ...
  <section id="detalle-servicios-hubspot" style="padding: 50px">
    <div class="container-fluid">
      <div class="row mb-5" style="margin-bottom: -7.5rem !important">
        ...
        <div class="col-md-6">
          <img src="sources/images/Imagenes Pixiu/Operating system-amico.png" alt="HubSpot Implementation and Training" class="service-detail-img" />
        </div>
      </div>
      <div class="row mb-5" style="margin-bottom: -7.5rem !important">
        ...
        <div class="col-md-6 order-md-1">
          <img src="sources/images/Imagenes Pixiu/Operating system-pana.png" alt="HubSpot Optimization" class="service-detail-img" />
        </div>
      </div>
      <div class="row mb-5" style="margin-bottom: -2.5rem !important">
        ...
        <div class="col-md-6">
          <img src="sources/images/Imagenes Pixiu/Operating system-rafiki.png" alt="Personalized HubSpot Consulting" class="service-detail-img" />
        </div>
      </div>
    </div>
  </section>
        ...
        <div class="col-md-3">
          <div class="plan">
            <div class="inner">
              ...
              <div class="action">
                <a class="button" href="https://meetings.hubspot.com/pixiu" style="color: #fff" target="_blank">Book A Call</a>
              </div>
            </div>
          </div>
        </div>
