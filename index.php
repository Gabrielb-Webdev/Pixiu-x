...
<body>
                ...
                <div class="col-md-6 mb-3">
                  <div class="card border-0">
                    <div class="card-body">
                      ...
                      <a href="web.php" style="color: #dd6d2c">learn more
                        <img src="sources/icons/arrow.svg" alt="Arrow" class="ml-2" /></a>
                    </div>
                  </div>
                </div>
                <div class="col-md-6 mb-3">
    ...
    <div class="container-fluid">
      ...
      <div class="row align-items-center">
        <div class="col-md-6 text-left">
          <img src="sources/images/hubspot.webp" alt="Imagen de servicios hubspot" class="img-fluid mb-4" />
        </div>
        <div class="col-md-6 d-flex align-items-end justify-content-center">
          <div class="text-justify">
            ...
            <a href="hubspot.php" class="btn btn-custom-orange btn-lg mt-4">Learn More</a>
          </div>
        </div>
      </div>
    </div>
      ...
      <div class="row align-items-center">
        <div class="col-md-6 d-flex align-items-end justify-content-center">
          <div class="text-justify">
            ...
            <a href="scrap.php" class="btn btn-custom-orange btn-lg mt-4">Learn More</a>
          </div>
        </div>
  ...
  <script>
    ...
    function updateView() {
      ...
      stepsElement.style.transform = `translateX(-${currentStep * stepWidth * 1.1
        }px)`;
    }
