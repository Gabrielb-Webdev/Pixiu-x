...
<head>
  ...
  <meta name="description" content="Pixiu X specializes in crafting powerful data extraction tools swiftly, including web scrapers and automated processes. Explore our services: website data extraction, prospect/lead data extraction, social media data extraction, and market research data extraction.">
  <meta name="keywords" content="data extraction tools, web scrapers, automate data extraction, website data extraction, prospect data extraction, lead data extraction, social media data extraction, market research data extraction, data scraping, web data APIs, data collection services, data automation, Pixiu X">
  ...
  <section id="detalle-servicios-hubspot" style="padding: 50px">
    <div class="container-fluid">
      <div class="row mb-5" style="margin-bottom: -4rem !important">
        ...
        <div class="col-md-6">
          <img src="sources/images/Imagenes Pixiu/Data extraction-amico.png" alt="HubSpot Implementation and Training" class="service-detail-img" />
        </div>
      </div>
      <div class="row mb-5" style="margin-bottom: -1.5rem !important">
        ...
        <div class="col-md-6 order-md-1">
          <img src="sources/images/Imagenes Pixiu/Data extraction-rafiki.png" alt="HubSpot Optimization" class="service-detail-img" />
        </div>
      </div>
      <div class="row mb-5" style="margin-bottom: -2.5rem !important">
        ...
        <div class="col-md-6">
          <img src="sources/images/Imagenes Pixiu/Data extraction-cuate.png" alt="Personalized HubSpot Consulting" class="service-detail-img" />
        </div>
      </div>
      <div class="row mb-5" style="margin-bottom: -2.5rem !important">
        <div class="col-md-6 order-md-2 d-flex align-items-center">
        ...
        <div class="col-md-6 order-md-1">
          <img src="sources/images/Imagenes Pixiu/Telecommuting-rafiki.png" alt="HubSpot Optimization" class="service-detail-img" />
        </div>
      </div>
    </div>
  </section>
