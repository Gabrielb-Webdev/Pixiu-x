  ...
  <section id="detalle-servicios-hubspot" style="padding: 50px">
    <div class="container-fluid">
      <div class="row mb-5" style="margin-bottom: -2.5rem !important">
        ...
        <div class="col-md-6">
          <img src="sources/images/Imagenes Pixiu/Website Creator-bro.png" alt="Diseño Web" class="service-detail-img" />
        </div>
      </div>
      <div class="row mb-5" style="margin-bottom: -5rem !important">
        ...
        <div class="col-md-6 order-md-1">
          <img src="sources/images/Imagenes Pixiu/Website Creator-pana.png" alt="Desarrollo Web Personalizado" class="service-detail-img" />
        </div>
      </div>
      <div class="row mb-5" style="margin-bottom: -2.5rem !important">
        <div class="col-md-6 d-flex align-items-center">
        ...
        <div class="col-md-6">
          <img src="sources/images/Imagenes Pixiu/Website Creator-rafiki.png" alt="Desarrollo de E-commerce" class="service-detail-img" />
        </div>
      </div>
      <div class="row mb-5" style="margin-bottom: -2.5rem !important">
        <div class="col-md-6 order-md-2 d-flex align-items-center">
        ...
        <div class="col-md-6">
          <img src="sources/images/Imagenes Pixiu/Hand coding-cuate.png" alt="Aplicaciones Móviles" class="service-detail-img" />
        </div>
      </div>
    </div>
  </section>
