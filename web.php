...
<head>
  ...
  <meta name="description" content="Pixiu X specializes in crafting tailored software solutions that precisely align with business requirements. We deliver high-quality, efficient, and scalable software development services to optimize operations and fuel business growth.">
  <meta name="keywords" content="Pixiu X, custom software development, bespoke software solutions, tailored software development, web design, custom web development, e-commerce development, mobile applications, software optimization, business growth strategies, digital transformation, enterprise solutions, dynamic web applications, interactive web solutions, scalable software solutions, technology consulting, software integration, agile development, responsive web design">
  ...
  <section id="detalle-servicios-hubspot" style="padding: 50px">
    <div class="container-fluid">
      <div class="row mb-5" style="margin-bottom: -2.5rem !important">
        ...
        <div class="col-md-6">
          <img src="sources/images/Imagenes Pixiu/Website Creator-bro.png" alt="Web Design" class="service-detail-img" />
        </div>
      </div>
      <div class="row mb-5" style="margin-bottom: -5rem !important">
        ...
        <div class="col-md-6 order-md-1">
          <img src="sources/images/Imagenes Pixiu/Website Creator-pana.png" alt="Custom Web Development" class="service-detail-img" />
        </div>
      </div>
      <div class="row mb-5" style="margin-bottom: -2.5rem !important">
        <div class="col-md-6 d-flex align-items-center">
        ...
        <div class="col-md-6">
          <img src="sources/images/Imagenes Pixiu/Website Creator-rafiki.png" alt="E-commerce Web Development" class="service-detail-img" />
        </div>
      </div>
      <div class="row mb-5" style="margin-bottom: -2.5rem !important">
        <div class="col-md-6 order-md-2 d-flex align-items-center">
        ...
        <div class="col-md-6">
          <img src="sources/images/Imagenes Pixiu/Hand coding-cuate.png" alt="Mobile Applications" class="service-detail-img" />
        </div>
      </div>
    </div>
  </section>
